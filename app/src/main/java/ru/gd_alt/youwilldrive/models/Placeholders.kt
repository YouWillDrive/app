...
object Placeholders {
    ...
    val DefaultPlanHistoryPoint = PlanHistoryPoint("0", 0, DefaultDateTime1.toInstant(ZoneOffset.of("Europe/Moscow")))
    ...
    val DefaultEvent = Event("0", DefaultDateTime1.toInstant(ZoneOffset.of("Europe/Moscow")))
    val DefaultEvent1 = Event("1", DefaultDateTime2.toInstant(ZoneOffset.of("Europe/Moscow")))
    val DefaultEvent2 = Event("2", DefaultDateTime4.toInstant(ZoneOffset.of("Europe/Moscow")))
    val DefaultEvent3 = Event("3", DefaultDateTime3.toInstant(ZoneOffset.of("Europe/Moscow")))
